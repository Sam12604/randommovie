...
async function getData() {
	response1 = await fetch('https://randomovie.samharris.xyz/keywords.json');
	...
	response = await fetch('https://api.themoviedb.org/3/discover/movie?vote_count.gte=1200&with_keywords=' + keyword + '&api_key=8c3bccbc2733907ba7cfeddb6e80ee5e');
